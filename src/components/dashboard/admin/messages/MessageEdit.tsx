...
import { getMessageAPI } from "../../api/admin/messages/getMessageAPI";
import { updateMessageAPI } from "../../api/admin/messages/updateMessageAPI";
...
const MessageEdit = ({ setOpenEdit, messageId }: { setOpenEdit: Function, messageId: any }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        let result = await updateMessageAPI(form, messageId);
        if (result) {

...
const ProfileTab = () => {
    ...
    const [profile, setProfile] = useState<any>(admin?.profile as unknown as any || {});
    ...
    const handleSaveProfile = async () => {
        ...
        let update = await updateUserProfileAPI(admin?.userId as unknown as number, formData);
    ...
    useEffect(() => {
        (async () => {
            const data = await getUserProfileAPI(admin?.userId as unknown as number, );
            setProfile(data);
        })();
    }, [admin?.userId])
